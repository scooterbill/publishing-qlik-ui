...
describe('Locale: no', function() {
  ...
  describe('Currency', function() {
    it('should format a currency', function() {
      var tests = [[1000.234, '$0,0.00', 'kr1 000,23'], [-1000.234, '($0,0)', '(kr1 000)'], [-1000.234, '$0.00', '-kr1000,23'], [1230974, '($0.00a)', 'kr1,23m']];
      for (var i = 0; i < tests.length; i++) {
        expect(numeral(tests[i][0]).format(tests[i][1])).to.equal(tests[i][2]);
      }
    });
  ...
  describe('Unformat', function() {
    it('should unformat', function() {
      var tests = [['10 000,123', 10000.123], ['(0,12345)', -0.12345], ['(kr1,23m)', -1230000], ['10k', 10000], ['-10k', -10000], ['23.', 23], ['kr10 000,00', 10000], ['-76%', -0.76], ['2:23:57', 8637]];
      for (var i = 0; i < tests.length; i++) {
